...
//set Health = Stamina + 3; Willpower = Composure + Resolve. --done
...
//check that all Academics, Craft, Performance, and Science Skills have one speciality & check that there is one more speciality than the number of above skills taken.

// check for two dots in one Discipline and one dot in another Discipline.
...
// check for 2 points of flaws

// check for blood potency 1

//check final humanity